...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?> style="background:url('<?php
        if (localbusiness_get_option('localbusiness_bodybg') != '') {
            echo localbusiness_get_option('localbusiness_bodybg');
        } else {
            ?><?php echo get_template_directory_uri(); ?>/images/bg.png<?php } ?>');">
        <div class="wrapper">
